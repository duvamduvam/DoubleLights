...
from files.hardrive_json_manager import HardDriveJsonManager

from dadou_utils.singleton import SingletonMeta

from hardrive_config import I2C_ENABLED, LIGHTS_PIN, PWM_CHANNELS_ENABLED, DIGITAL_CHANNELS_ENABLED, DEVICES_LIST

from hardrive_config import LOGGING_CONFIG_FILE
...
class RobotFactory(metaclass=SingletonMeta):
    ...
    def __init__(self):
        ...
        self.robot_json_manager = HardDriveJsonManager()
